...
struct HistoryRow {
  ...
  double wire_gradient_l1{}, density_gradient_l1{},
...
[[nodiscard]] double paperInitialLambda(double wire_gradient_l1,
                                        double density_gradient_l1);
[[nodiscard]] double polakRibiereBeta(const std::vector<double> &g,
                                      const std::vector<double> &previous);
[[nodiscard]] double nextPaperLambda(double lambda, double current_ofr,
                                     double previous_ofr, bool has_previous);
[[nodiscard]] int paperNoImprovementLimit(size_t movable_count);
[[nodiscard]] OptimizeResult optimizeLevel(Level &, const Region &,
                                           const DensityGrid &,
